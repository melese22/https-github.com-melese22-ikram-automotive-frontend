      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Track and manage repair orders</p>
            </div>
          </div>
          {user?.role !== 'Customer' && (
            <button
        ...
        {showCreate && (
          <form onSubmit={handleCreate} className="bg-white rounded-2xl border border-gray-200/80 p-6 mb-6 shadow-sm">
            <h3 className="font-semibold text-gray-900 mb-4 flex items-center gap-2">
              <HiOutlinePlusCircle className="w-4 h-4 text-indigo-500" />
              Create Job Card
            </h3>
            ...
            <button
              ...
              className="mt-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-2.5 rounded-xl text-sm font-semibold hover:from-indigo-700 hover:to-purple-700 disabled:opacity-50 shadow-sm transition-all"
            >
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16 bg-white rounded-2xl border border-dashed border-gray-300">
            <HiOutlineClipboardDocumentList className="w-10 h-10 mx-auto text-gray-300 mb-3" />
                ...
                {jobCards?.map((card: any) => (
                  ...
                  >
                    <td className="px-6 py-4">
                      ...
                      <div className="text-xs text-gray-400">{card.plate_number || card.vin || ''}</div>
                    </td>
